...
export default function Navbar() {
  ...
  return (
    ...
    {/* Mobile hamburger */}
      ...
      <div className={`${menuOpen ? "flex" : "hidden"} sm:flex flex-col sm: items-start sm:items-center gap-4 px-4 pb-4 sm:py-3 border-t border-white/20 sm:border-none w-full}`}>
 {/*  /*/}
