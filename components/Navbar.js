...
export default function Navbar() {
  ...
  return (
    <nav className="bg-primary text-white sticky top-0 z-50 shadow-md flex-wrap">
      <div className="max-w-6xl mx-auto px-4 py-3 flex-wrap items-center justify-between">
