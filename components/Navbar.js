...
export default function Navbar() {
  ...
  return (
    <nav className="bg-primary text-white sticky top-0 z-50 shadow-md w-full">
      {/* 1. السطر الأول: اللوجو والزر فقط */}
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between w-full">
        {/* اللوجو على اليمين / اليسار حسب تصميمك */}
        <div className="flex items-center gap-2">
          <Image src="/images/badges/rih.jpg" width={60} height={60} className="font-bold rounded-full object-cover" alt="logo" />
          <Link href="/" className="text-xl font-bold flex items-center gap-2">
            <span>رحلة إلى الجنّة</span>
          </Link>
        </div>

        {/* Mobile hamburger على الجهة المقابلة */}
...
<br></br>
      ...
      <div className={`${menuOpen ? "flex" : "hidden"} sm:flex flex-row flex-wrap items-center justify-center gap-4 px-4 py-3 border-t border-white/20 w-full `}>
        ...
        <Link href="/calendar-planner" className={navLinkClass("/calendar-planner")}>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-calendar2-heart-fill" viewBox="0 0 16 16">
        ...
        <Link href="/bee" className={navLinkClass("/bee")}>
...
// {/*   
//           <div className="sm:hidden flex flex-row items-center justify-center gap-4 mt-4 pt-4 border-t border-white/20">
//            */}
...
//    {/* <div className={`${menuOpen ? "flex" : "hidden"} sm:flex flex-wrap flex-row gap-4 mt-4 pt-4 items-start gap-4 pb-4 px-4 border-t border-white/20 w-full overflow-x-auto}`}> */}
    
//     {/* العناصر بالعرض */}
//   {/* <div className={`${menuOpen ? "flex" : "hidden"} sm:flex flex-row items-center justify-center gap-4 px-4 py-3 border-t border-white/20 w-full overflow-x-auto}`}> */}
